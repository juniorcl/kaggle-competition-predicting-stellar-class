...
def tune_catboost(X_train: pd.DataFrame, y_train: pd.DataFrame | pd.Series, target: str, model_path: str) -> tuple:
    ...
    def objective(trial, X, y):
        ...
        for fold, (train_idx, valid_idx) in enumerate(cv.split(X, y)):
            ...
            model = make_pipeline(
                CatBoostEncoder(cols=['spectral_type', 'galaxy_population']),
                CatBoostClassifier(
